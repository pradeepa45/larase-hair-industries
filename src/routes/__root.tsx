...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "LARASE HAIR INDUSTRIES PRIVATE LIMITED | 100% Natural Human Hair" },
      {
        name: "description",
        content:
          "Larase Hair Industries Private Limited, Guntur — manufacturer and exporter of 100% natural Indian human hair. GST 37AAFCL8708G1ZA. IEC AAFCL8708G.",
      },
